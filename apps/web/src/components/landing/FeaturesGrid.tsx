...
export default function FeaturesGrid() {
  return (
    <section
      className="w-full py-24 geo-grid-bg relative"
          ...
          {features.map((feature, index) => (
            <RevealOnScroll key={index} delay={index * 100}>
              ...
              >
                ...
                {/* Title */}
                <h3
                  className="font-display text-gold-primary uppercase mb-3"
                  style={{ fontSize: '12px', fontWeight: 700, letterSpacing: '0.12em', lineHeight: '1.4' }}
                >
                  {feature.title}
                </h3>
