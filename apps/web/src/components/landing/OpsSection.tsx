...
const terminalLines = [
  ...
  { prefix: '>', text: 'CLASSIFICATION: CONFIDENTIEL-UEE', color: '#e05252' },
]
      ...
      <div className="mx-auto px-10" style={{ maxWidth: '1440px' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {terminalLines.map((line, i) => (
                  <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                    <span style={{ color: '#8a6f35', flexShrink: 0, fontSize: '13px' }}>
                      {line.prefix}
                    </span>
                    <span style={{ color: line.color, fontSize: '13px', letterSpacing: '0.02em' }}>
                      {line.text}
                    </span>
                  </div>
                ))}
          ...
          <div>
            ...
            >
              Nos campagnes sont préparées comme des opérations d&apos;état-major:
              objectifs explicites, chaîne de commandement validée et exécution coordonnée
              entre escouades spécialisées.
            </p>
            ...
            <p
              ...
              style={{ fontSize: '14px', lineHeight: '1.8' }}
            >
              De l&apos;interception tactique à l&apos;offensive multi-vecteur, la doctrine reste la même:
              discipline collective, responsabilité individuelle et débrief systématique après engagement.
            </p>
